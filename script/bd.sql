...
BEGIN
    	INSERT INTO BETS VALUES (PID_BET,PID_USER,PID_GAME,
			PRESULT1,PRESULT2,PPAY,PACTIVE)
		ON DUPLICATE KEY
    	UPDATE ID_BET=PID_BET,ID_USER=PID_USER,ID_GAME=PID_GAME,
		RESULT1=PRESULT1,RESULT2=PRESULT2,PAY=PPAY,ACTIVE=PACTIVE;   
