...
class Start
{
	...
	public function winners( $params ) {
    	...
    	$sql .= " ( SELECT SUM(VALUE) FROM GAMES G INNER JOIN BETS B ON B.ID_GAME = G.ID_GAME WHERE G.ID_GAME = GAMES.ID_GAME ) AS VLR ";
        ...
        $sql .= " AND BETS.RESULT1 = GAMES.RESULT1 AND BETS.RESULT2 = GAMES.RESULT2 ";
