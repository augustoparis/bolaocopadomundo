<div id="div-games" style="display: none;" >
					...
					<form id="form-games" role="form" >	
						...
						<div class="form-group">
							...
							<div class="input-group margin-bottom-sm">
								...
								<input type="text" class="form-control" id="value" name="value" required editar="VALUE" minlength="2" >
							</div>							
						</div>
						<div class="form-group">
							...
							<div class="input-group margin-bottom-sm">
								...
								<input type="text" class="form-control" id="date" name="date" required editar="DATE" minlength="5" >
							</div>							
						</div>
						<div class="form-group">
							...
							<div class="input-group margin-bottom-sm">
							  	<span class="input-group-addon"><i class="fa fa-lock fa-fw"></i></span>
								<input type="text" class="form-control" id="hour" name="hour" required editar="HOUR" minlength="5" >
							</div>							
						</div>
						<!--
						<div class="checkbox">
							<label for="ativo" ><input id="ativo" name="ativo" type="checkbox" value="1" checked editar="ATIVO" > aasd</label>
						</div>
						-->						
	...
	<div class="table-responsive">
		<table id='table-games' class="table table-bordered table-striped">
			<thead>
				<tr>
					<th width='4%' ><div onclick="Games.novo()" class="btn btn-primary" ><span class="glyphicon glyphicon-plus"></span></div></th>
					...
					<!--<th width='6%' ><label><input id="ativo" name="ativo" type="checkbox" value="1" onclick="Games.ativo()" checked > dddddda</label></th>-->
